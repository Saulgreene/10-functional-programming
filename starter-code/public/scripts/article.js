...
(function(module){
  ...
  // TODODONE: Chain together a `map` and a `reduce` call to produce an array of unique author names.
  Article.allAuthors = () => {
  ...
  Article.numWordsByAuthor = () => {
    return Article.allAuthors().map(author => {
        return {
          author: author,
          stat: Article.all.filter(function(articleObject){
      ...
      // TODODONE: Transform each author string into an object with properties for
